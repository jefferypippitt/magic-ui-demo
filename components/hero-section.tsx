        ...
        <div className='flex flex-col items-center justify-center gap-3 pb-3 pt-4 lg:pb-4 lg:pt-6'>
          <div className='flex flex-col gap-3'>
            <h1 className='max-w-xl text-center text-xl font-semibold leading-normal tracking-tight md:text-3xl lg:text-4xl'>
              Welcome to{' '}
              <span className='animate-gradient inline-block bg-gradient-to-r from-[hsl(var(--color-1))] via-[hsl(var(--color-2))] to-[hsl(var(--color-3))] bg-clip-text leading-[1.2] py-1 text-transparent'>
                Magicui
              </span>
            </h1>
            <div className='relative h-10 w-full md:h-14'>
              <WordRotate
