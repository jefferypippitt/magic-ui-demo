  ...
  return (
    ...
    >
          ...
          style={
            {
              ...
              strokeDasharray: `calc((100 - ${currentPercent}) * var(--percent-to-px)) var(--circumference)`,
      ...
      <span
        ...
        className="duration-&lsqb;var(--transition-length)&rsqb; delay-&lsqb;var(--delay)&rsqb; absolute inset-0 m-auto h-fit w-fit ease-linear animate-in fade-in"
      >
